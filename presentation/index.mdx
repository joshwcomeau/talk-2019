...
- Improve time to first paint (SSR)
- Improve time to interactivity (code-splitting, lazy-loading)

---

...but what is the product like to use?
...
Particle component API, angle and distance
...
Quick Particle code walkthrough
