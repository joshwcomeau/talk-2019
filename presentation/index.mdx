...
# People dislike staring at a blank speed, but feedback delays are even worse!

---

# Case Study: EMT feedback
...
There are other ecosystems than the web.

<!--

The web is not the only ecosystem out there - we can compare and contrast with mobile
...
Mobile apps are much higher-friction, in terms of first-time latency
...
People never like waiting, but the tolerances vary.
