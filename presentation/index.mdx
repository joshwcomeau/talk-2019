...
import digitalOceanLogoSrc from '../assets/digital-ocean-logo.jpg'

<img src={digitalOceanLogoSrc} />
...
Clearly, Time To Interactive is important.
...
People avoid websites/apps with input latency.

It can be hard to measure, in aggregate.
...
React's concurrent mode lets you prioritize updates\*.

Shout-out to Philipp Spies' [amazing blog post](https://philippspiess.com/scheduling-in-react/) on the subject.

<br />
<br />

\* Currently a working but unstable API
...
Many reasons, but I think a big one is that they feel nice to use. The _user experience_ is better.
...
export default props => (
  <CodeSlide
    ...
    ranges={[
      ...
      { loc: [0], title: '⚡️️️️️⚡️️️️️⚡️️️️️⚡️️️️️' },
      { loc: [8, 9] },
      { loc: [31, 38] },
      { loc: [47, 48] },
      { loc: [38, 46] },
...
export default props => (
  <CodeSlide
    ...
    ranges={[{ loc: [50, 55] }, { loc: [55, 67] }, { loc: [67, 76] }]}
  />
)
...
<SpacedRow>
  <Tweet tweetContents="Hello React Rally! 👋🏻" />
</SpacedRow>
...
This was a terrific improvement, but more can be done!
...
## People hate page-load lag

---

## People hate input-feedback lag

---

## People hate animation lag
...
For other apps? Your mileage may vary.

---

Test your product on low-powered devices, and see where the pain points are. Metrics aren't collected evenly.
